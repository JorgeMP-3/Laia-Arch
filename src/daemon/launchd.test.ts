...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    ...
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", LAIA_ARCH_PROFILE: "default" },
    });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when LAIA_ARCH_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.openclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when LAIA_ARCH_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", LAIA_ARCH_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.openclaw.jbphoenix.plist",
    },
    {
      name: "prefers LAIA_ARCH_LAUNCHD_LABEL over LAIA_ARCH_PROFILE",
      env: {
        HOME: "/Users/test",
        LAIA_ARCH_PROFILE: "jbphoenix",
        LAIA_ARCH_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from LAIA_ARCH_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        LAIA_ARCH_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty LAIA_ARCH_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        LAIA_ARCH_PROFILE: "myprofile",
        LAIA_ARCH_LAUNCHD_LABEL: "   ",
      },
