...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    envSnapshot = captureEnv(["LAIA_ARCH_STATE_DIR", "NODE_ENV", "VITEST"]);
    process.env.LAIA_ARCH_STATE_DIR = tempDir;
    ...
    if (!loaded) {
      ({ resolveOpenClawPackageRoot } = await import("./laia-arch-root.js"));
