...
beforeEach(() => {
  ...
  originalOpenClawTestConsole = process.env.LAIA_ARCH_TEST_CONSOLE;
  process.env.LAIA_ARCH_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalOpenClawTestConsole === undefined) {
    delete process.env.LAIA_ARCH_TEST_CONSOLE;
  } else {
    process.env.LAIA_ARCH_TEST_CONSOLE = originalOpenClawTestConsole;
  }
