...
export async function startGatewaySidecars(params: {
  ...
  // Tests can opt out via LAIA_ARCH_SKIP_CHANNELS (or legacy LAIA_ARCH_SKIP_PROVIDERS).
  const skipChannels =
  ...
  if (!skipChannels) {
    ...
    params.logChannels.info(
      "skipping channel start (LAIA_ARCH_SKIP_CHANNELS=1 or LAIA_ARCH_SKIP_PROVIDERS=1)",
    );
  }
