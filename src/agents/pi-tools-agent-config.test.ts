...
describe("Agent-specific tool filtering", () => {
  ...
  async function withApplyPatchEscapeCase(
    ...
    try {
      ...
      const tools = createLaiaArchCodingTools({
        config: cfg,
...
*** End Patch`;
  ...
  function createMainSessionTools(cfg: OpenClawConfig) {
    return createLaiaArchCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createLaiaArchCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createLaiaArchCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createLaiaArchCodingTools({
      config: cfg,
    ...
    const defaultTools = createLaiaArchCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createLaiaArchCodingTools({
      config: cfg,
    ...
    const bobTools = createLaiaArchCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createLaiaArchCodingTools({
      config: cfg,
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const helperTools = createLaiaArchCodingTools({
      config: cfg,
