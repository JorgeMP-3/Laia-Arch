...
import { __testing, createLaiaArchCodingTools } from "./pi-tools.js";
...
describe("createLaiaArchCodingTools", () => {
  ...
  it("exposes raw for gateway config.apply tool calls", () => {
    const gateway = createLaiaArchCodingTools({ senderIsOwner: true }).find(
  ...
  it("removes unsupported JSON Schema keywords for Cloud Code Assist API compatibility", () => {
    const googleTools = createLaiaArchCodingTools({
  ...
  it("applies xai model compat for direct Grok tool cleanup", () => {
    const xaiTools = createLaiaArchCodingTools({
      modelProvider: "xai",
