...
describe("gateway tool defaults", () => {
  const envSnapshot = {
    openclaw: process.env.LAIA_ARCH_GATEWAY_TOKEN,
  ...
  afterAll(() => {
    if (envSnapshot.openclaw === undefined) {
      ...
      process.env.LAIA_ARCH_GATEWAY_TOKEN = envSnapshot.openclaw;
    }
  ...
  it("uses LAIA_ARCH_GATEWAY_TOKEN for allowlisted local overrides", () => {
  ...
  it("does not leak local env/config tokens to remote overrides", () => {
    process.env.LAIA_ARCH_GATEWAY_TOKEN = "local-env-token";
