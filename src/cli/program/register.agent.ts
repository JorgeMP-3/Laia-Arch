...
${formatHelpExamples([
  ['laia-arch agent --to +15555550123 --message "status update"', "Start a new session."],
  ['laia-arch agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'laia-arch agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'laia-arch agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['laia-arch agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'laia-arch agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
...
${formatHelpExamples([
  [
    'laia-arch agents set-identity --agent main --name "Laia Arch" --emoji "🤖"',
    "Set name + emoji.",
  ],
  ["laia-arch agents set-identity --agent main --avatar avatars/laia-arch.png", "Set avatar path."],
  [
    "laia-arch agents set-identity --workspace ~/.laia-arch/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "laia-arch agents set-identity --identity-file ~/.laia-arch/workspace/IDENTITY.md --agent main",
