...
describe("registerSubCliCommands", () => {
  ...
  const originalDisableLazySubcommands = process.env.LAIA_ARCH_DISABLE_LAZY_SUBCOMMANDS;
  ...
  beforeEach(() => {
    if (originalDisableLazySubcommands === undefined) {
      delete process.env.LAIA_ARCH_DISABLE_LAZY_SUBCOMMANDS;
    } else {
      process.env.LAIA_ARCH_DISABLE_LAZY_SUBCOMMANDS = originalDisableLazySubcommands;
    }
