...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.LAIA_ARCH_SERVICE_MARKER;
  ...
  beforeEach(async () => {
    ...
    delete process.env.LAIA_ARCH_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.LAIA_ARCH_SERVICE_MARKER = originalServiceMarker;
    }
  });
