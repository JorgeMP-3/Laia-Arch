...
export const INSTALLER_USERNAME_DESCRIPTION =
  `Usuario en minúsculas, por ejemplo: ${INSTALLER_USERNAME_EXAMPLE}`;
export const INVALID_INSTALLER_USERNAME_MESSAGE =
  `username inválido: usa minúsculas, por ejemplo: ${INSTALLER_USERNAME_EXAMPLE}`;
