...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.LAIA_ARCH_GATEWAY_PORT;
    process.env.LAIA_ARCH_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.LAIA_ARCH_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.LAIA_ARCH_GATEWAY_PASSWORD;
