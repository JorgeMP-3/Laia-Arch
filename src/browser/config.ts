...
import {
  ...
  DEFAULT_LAIA_ARCH_BROWSER_ENABLED,
...
function normalizeHexColor(raw: string | undefined) {
  ...
  if (!value) {
    return DEFAULT_LAIA_ARCH_BROWSER_COLOR;
  }
...
function ensureDefaultProfile(
  ...
  if (!result[DEFAULT_LAIA_ARCH_BROWSER_PROFILE_NAME]) {
    result[DEFAULT_LAIA_ARCH_BROWSER_PROFILE_NAME] = {
...
export function resolveBrowserConfig(
  ...
  const enabled = cfg?.enabled ?? DEFAULT_LAIA_ARCH_BROWSER_ENABLED;
  ...
  const defaultProfile =
    ...
    (profiles[DEFAULT_BROWSER_DEFAULT_PROFILE_NAME]
      ? DEFAULT_BROWSER_DEFAULT_PROFILE_NAME
      : profiles[DEFAULT_LAIA_ARCH_BROWSER_PROFILE_NAME]
        ? DEFAULT_LAIA_ARCH_BROWSER_PROFILE_NAME
        : "user");
